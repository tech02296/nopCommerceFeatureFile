Feature: Nopcommerce Registration
  As a User
  I want to check the Register functionlity of Nopcommerce
  ...
  Scenario Outline: I should not be able to register with invalid data on mandatory field (*) of registration page
    ...
    And      I enter confirm Passwpord "<Confirm Password>"
    ...
    Examples:
      ...
      | Rohan      | bakshi    | ""               | 456897   | 456897           | please enter vaild email                   |
      | Rohan      | bakshi    | bakshi@gmai.com  | ""       | 456897           | password is required                       |
      | Rohan      | bakshi    | bakshi@gmail.com | 456897   | ""               | confirm password is required               |
      | Rohan      | bakshi    | bakshi@gmail.com | 456897   | 45678            | password and confirm password do not match |
